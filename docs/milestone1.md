...
![MSE](cs207-FinalProject/blob/milestone1/docs/MSE.png)
...
![Chain Rule](cs207-FinalProject/blob/milestone1/docs/Chain_rule.png)
...
![Vector Input Example](cs207-FinalProject/blob/milestone1/docs/Vector%20Input%20Example.png)
